...
class UpdateBitcoinableWebhookApiRequest extends FormRequest
{
    /**
    ...
    {
        $webhook = BitcoinableWebhook::where('uuid', $this->route('webhookId'))->with('bitcoinable_webhook')->firstOrFail();
