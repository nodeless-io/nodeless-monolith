...
class GatedMessage extends Resource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\GatedMessage>
     */
    public static $model = \App\Models\GatedMessage::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            BelongsTo::make('Gated Message Request', 'request'),
