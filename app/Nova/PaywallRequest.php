...
class PaywallRequest extends Resource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\PaywallRequest>
     */
    public static $model = \App\Models\PaywallRequest::class;
