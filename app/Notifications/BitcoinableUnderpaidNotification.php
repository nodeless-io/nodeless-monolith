...
class BitcoinableUnderpaidNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
                    ...
                    ->subject('You Received an Underpayment')
                    ->line('You received a payment, but the customer sent you less than we expected.')
                    ->line('Amount Invoiced: ' . $this->bitcoinable->amount . ' sats')
