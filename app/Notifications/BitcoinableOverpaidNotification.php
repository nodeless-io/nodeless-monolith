...
class BitcoinableOverpaidNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
                    ...
                    ->subject('You Received an Overpayment')
                    ->line('You received a payment, but the customer sent you more than we expected.')
