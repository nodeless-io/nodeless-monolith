...
const CreatePaywallWebhookModal = () => {
  const {
  ...
  const { isLoading, mutateAsync } = useMutation(
    async (payload: ICreateDonationPageWebhook) => {
    ...
    {
      onSuccess: () => {
        queryClient.invalidateQueries([`paywall-webhooks-${paywallId}`]);
        setState({
          ...initialState,
          secret: generateSecret(),
        });
  ...
  const handleSubmit = async (e) => {
    ...
    await mutateAsync(formatCreateWebhookData({ ...state, uuid: paywallId }));
  };

  return (
    <Modal
      handleClose={() => setCreatePaywallWebhooksModalOpen(false)}
      open={createPaywallWebhooksModalOpen}
      title="Add Webhook"
      isCenter={false}
      isDivider={isDivider()}
    >
      <Box component="form" autoComplete="off" onSubmit={handleSubmit}>
        ...
        <Box sx={styles.section}>
          ...
          <FormGroup>
            ...
            <FormControlLabel
              ...
              sx={styles.checkboxLabel}
              label={
                <Typography sx={styles.checkboxLabel}>Request Paid</Typography>
              }
            />
            <FormControlLabel
              control={
        ...
        <Box sx={styles.footer}>
          ...
          >
            <SecondaryOutlinedButton
              text="Cancel"
              onClick={() => setCreatePaywallWebhooksModalOpen(false)}
...
export default CreatePaywallWebhookModal;
