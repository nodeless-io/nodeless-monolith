...
export default function CreatePaywallModal() {
  const { createPaywallModal, setCreatePaywallModal } = React.useContext(
    PaywallContext
  );
  ...
  return (
    <Modal
      handleClose={() => setCreatePaywallModal(false)}
      open={createPaywallModal}
      title="Add Paywall"
      maxWidth="md"
    >
      <Box
        ...
        {state.type == "content" && (
          <Box sx={{ margin: "10px 0 20px 0" }}>
            <Typography sx={{ ...styles.textFieldLabel, fontSize: "12px" }}>
              Content <span style={{ marginLeft: "5px", color: "red" }}>*</span>
            </Typography>
