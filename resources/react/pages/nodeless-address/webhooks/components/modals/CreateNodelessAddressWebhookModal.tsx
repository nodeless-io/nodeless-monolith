...
const CreateNodelessAddressWebhookModal = () => {
  ...
  const { isLoading, mutateAsync } = useMutation(createInboxWebhooks, {
    onSuccess: () => {
      ...
      setCreateNodelessAddressWebhooksModalOpen(false);
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = formatCreateWebhookData({
      ...state,
      uuid: addressId,
    });
  ...
  return (
    <Modal
      handleClose={() => setCreateNodelessAddressWebhooksModalOpen(false)}
      open={createNodelessAddressWebhooksModalOpen}
      title="Add Webhook"
      isCenter={false}
    >
      <Box
      ...
      >
        ...
        <Box sx={styles.section}>
          ...
          <FormGroup>
            ...
            <FormControlLabel
              ...
              sx={styles.checkboxLabel}
              label={
                <Typography sx={styles.checkboxLabel}>Message Paid</Typography>
              }
            />
            <FormControlLabel
              control={
        ...
        <Box sx={styles.footer}>
          ...
          >
            <SecondaryOutlinedButton
              text="Cancel"
              onClick={() => setCreateNodelessAddressWebhooksModalOpen(false)}
...
export default CreateNodelessAddressWebhookModal;
