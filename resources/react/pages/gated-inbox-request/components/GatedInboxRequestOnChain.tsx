...
const GatedInboxRequestOnChain = () => {
  ...
  return (
    <Box sx={styles.content}>
      <div>
        <a href={nodelessAddressMessageRequest?.onchain_link}>
          <img
            src={nodelessAddressMessageRequest?.onchain_qr_code}
            width={250}
            height={250}
      ...
      <LinkButton
        ...
        link={nodelessAddressMessageRequest?.onchain_link}
      />
...
export default GatedInboxRequestOnChain;
