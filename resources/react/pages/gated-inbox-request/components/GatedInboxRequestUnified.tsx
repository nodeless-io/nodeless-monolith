...
const GatedInboxRequestUnified = () => {
  ...
  return (
    <Box sx={styles.content}>
      <div>
        <a href={nodelessAddressMessageRequest?.unified_link}>
          <img
            src={nodelessAddressMessageRequest?.unified_qr_code}
            width={250}
            height={250}
      ...
      <LinkButton
        ...
        link={nodelessAddressMessageRequest?.unified_link}
      />
      ...
      <Box sx={styles.inputBox}>
        <Typography sx={styles.amountBox}>
          {
            nodelessAddressMessageRequest?.gated_message?.lightning_invoice
              .payment_request
          }
        </Typography>
        <Typography
        ...
        <Box sx={{ display: "flex", marginLeft: "10px" }}>
          ...
          <Tooltip title="Copy to clip board">
            <IconButton
              ...
              onClick={() =>
                copyToClipboard(
                  nodelessAddressMessageRequest?.gated_message
      ...
      <Box sx={styles.inputBox}>
        <Typography sx={styles.amountBox}>
          {nodelessAddressMessageRequest?.gated_message.bitcoin_address.address}
        </Typography>
        ...
        <Box sx={{ display: "flex", marginLeft: "10px" }}>
          ...
          <Tooltip title="Copy to clip board">
            <IconButton
              ...
              onClick={() =>
                copyToClipboard(
                  nodelessAddressMessageRequest?.gated_message.bitcoin_address
                    .address
                )
              }
            >
...
export default GatedInboxRequestUnified;
