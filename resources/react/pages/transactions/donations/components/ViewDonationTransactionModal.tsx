...
const ViewDonationTransactionModal = () => {
  const {
          ...
          {donationLoading ? (
            ...
            <>
              ...
              >
                ...
                >
                  <span>{currentDonation?.name}</span>
                </Typography>
              </Box>
          ...
          <Box sx={styles.section}>
            ...
            <Box sx={styles.details}>
              ...
              {currentTransaction?.is_fee && (
                <>
                  <Grid container spacing={2} sx={styles.details}>
                    ...
                    <Grid item xs={12} md={8} sx={styles.rightGrid}>
                      <Typography sx={styles.detailsItemValue}>Fee</Typography>
                    </Grid>
                  </Grid>
              ...
              <Grid container spacing={2} sx={styles.details}>
                ...
                <Grid item xs={12} md={8} sx={styles.rightGrid}>
                  <Typography sx={styles.detailsItemValue}>
                    {currentDonation.type == "lightning"
                      ? "Lightning"
                      : "On Chain"}
                  </Typography>
                </Grid>
              ...
              <Grid container spacing={2} sx={styles.details}>
                <Grid item xs={12} md={4} sx={styles.leftGrid}>
                  <Typography sx={styles.detailsItemLabel}>Paid at:</Typography>
                </Grid>

                <Grid item xs={12} md={8} sx={styles.rightGrid}>
                  <Typography sx={styles.detailsItemValue}>
                    {formatDate(
                      new Date(currentDonation.paid_at),
                      "hh:mm A MMM D, YYYY"
                    )}
                  </Typography>
                </Grid>
...
export default ViewDonationTransactionModal;
