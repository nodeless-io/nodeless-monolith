...
import UpdateStoreCheckoutAppearanceModal from "./modals/UpdateStoreCheckoutAppearanceModal";

function StoreCheckoutAppearanceHeader() {
  ...
  return (
    <Box sx={styles.container}>
      ...
      <UpdateStoreCheckoutAppearanceModal store={store} />
    </Box>
  );
}
...
export default StoreCheckoutAppearanceHeader;
